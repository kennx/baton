...
## 项目介绍
 ...
 baton 是一个基于 [M5StickS3 ESP32S3 Mini IoT Dev Kit](./docs/M5StickS3.md) 的红外线家电控制器，使用 ST7789P3 屏幕（135×240 分辨率）。当前已有一个 48×27 的 5×5 圆形点阵背景（`rgba(255,255,255,0.08)`）。M5StickS3 — ESP32-S3-PICO-1-N8R8, 8MB Flash + 8MB PSRAM, 1.14" 屏, 6轴IMU, ES8311+MEMS麦+AW8737功放, 250mAh电池, 红外收发
